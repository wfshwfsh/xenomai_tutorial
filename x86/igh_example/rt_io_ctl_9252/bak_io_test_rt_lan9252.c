...
const static ec_pdo_entry_reg_t domain1_regs[] = {
    {LAN9252_Pos, Microchip_LAN9252, 0x7010, 1, &off_dig_out},
    {LAN9252_Pos, Microchip_LAN9252, 0x6000, 1, &off_dig_in},
    {LAN9252_Pos, Microchip_LAN9252, 0x6020, 1, &off_dig_in2},
    {}
};
...
// Digital out ------------------------
static ec_pdo_entry_info_t el2016_rxPdo[] = {
    {0x7010, 1, 1}, // Value 1
    {0x7010, 2, 1}, // Value 2
    {0x7010, 3, 1}, // Value 3
    {0x7010, 4, 1}, // Value 4
...
static ec_pdo_entry_info_t el2016_txPdo1[] = {
    {0x6000, 1, 1}, // Value 1
    {0x6000, 2, 1}, // Value 2
    {0x6000, 3, 1}, // Value 3
    {0x6000, 4, 1}, // Value 4
...
static ec_pdo_entry_info_t el2016_txPdo2[] = {
    {0x6020, 1,  1}, // Value 1
    {0x6020, 2,  1}, // Value 2
    {0x6020, 3,  1}, // Value 3
    {0x6020, 5,  1}, // Value 5
    {0x6020, 17, 1}, // Value 17
};

static ec_pdo_info_t el2016_rxpdos[] = {
    {0x1601, 8, el2016_rxPdo+0},
    {0x1601, 8, el2016_rxPdo+1},
    {0x1601, 8, el2016_rxPdo+2},
    {0x1601, 8, el2016_rxPdo+3},
    {0x1601, 8, el2016_rxPdo+4},
    {0x1601, 8, el2016_rxPdo+5},
    {0x1601, 8, el2016_rxPdo+6},
    {0x1601, 8, el2016_rxPdo+7},
};

static ec_pdo_info_t el2016_txpdos1[] = {
    {0x1a00, 8, el2016_txPdo1+0},
    {0x1a00, 8, el2016_txPdo1+1},
    {0x1a00, 8, el2016_txPdo1+2},
    {0x1a00, 8, el2016_txPdo1+3},
    {0x1a00, 8, el2016_txPdo1+4},
    {0x1a00, 8, el2016_txPdo1+5},
    {0x1a00, 8, el2016_txPdo1+6},
    {0x1a00, 8, el2016_txPdo1+7},
};

static ec_pdo_info_t el2016_txpdos2[] = {
    {0x1a02, 8, el2016_txPdo2+0},
    {0x1a02, 8, el2016_txPdo2+1},
    {0x1a02, 8, el2016_txPdo2+2},
    {0x1a02, 8, el2016_txPdo2+3},
    {0x1a02, 8, el2016_txPdo2+4},
};

static ec_sync_info_t el2016_syncs[] = {
    {0, EC_DIR_OUTPUT, 1, el2016_rxpdos, EC_WD_ENABLE},
    {1, EC_DIR_INPUT,  1, el2016_txpdos1, EC_WD_DISABLE},
    {2, EC_DIR_INPUT,  1, el2016_txpdos2, EC_WD_ENABLE},
    {0xff}
};
...
void periodic_task (void *arg) {
	...
	while ( 1 ) 
	{
		...
		if(blink==100){
			...
			Dig_in2 = EC_READ_U8(domain1_pd + off_dig_in2);
			EC_WRITE_U8(domain1_pd + off_dig_out, Dig_out);

			rt_printf("Dig_out=0x%02x, Dig_in1=0x%02x, Dig_in2=0x%02x \n", Dig_out, Dig_in1, Dig_in2);
			blink=0;
		}
